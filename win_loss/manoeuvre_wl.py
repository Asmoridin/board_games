...
if os.getcwd().endswith('board_games'):
    file_h = open('wl_data/ManoData.txt', 'r', encoding="UTF-8")
    out_file_h = open("wl_data/ManoOut.txt", 'w', encoding="UTF-8")
else:
    file_h = open('board_games/wl_data/ManoData.txt', 'r', encoding="UTF-8")
    out_file_h = open("board_games/wl_data/ManoOut.txt", 'w', encoding="UTF-8")
